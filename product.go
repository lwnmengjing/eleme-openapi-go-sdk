...
// 创建配料组
// ingredientGroup 配料组数据
func (item *Item) CreateIngredientGroup(ingredientGroup_ interface{}) (interface{}, error) {
	params := make(map[string]interface{})
	params["ingredientGroup"] = ingredientGroup_
	return APIInterface(item.config, "eleme.product.item.createIngredientGroup", params)
}

// 批量创建配料组
// ingredientGroups 配料组数据
func (item *Item) BatchCreateIngredientGroups(ingredientGroups_ interface{}) (interface{}, error) {
	params := make(map[string]interface{})
	params["ingredientGroups"] = ingredientGroups_
	return APIInterface(item.config, "eleme.product.item.batchCreateIngredientGroups", params)
}

// 查询配料组
// ingredientGroupId 配料组id
func (item *Item) GetIngredientGroup(ingredientGroupId_ int64) (interface{}, error) {
	params := make(map[string]interface{})
	params["ingredientGroupId"] = ingredientGroupId_
	return APIInterface(item.config, "eleme.product.item.getIngredientGroup", params)
}

// 批量查询配料组
// ingredientGroupIds 配料组id列表
func (item *Item) ListIngredientGroups(ingredientGroupIds_ interface{}) (interface{}, error) {
	params := make(map[string]interface{})
	params["ingredientGroupIds"] = ingredientGroupIds_
	return APIInterface(item.config, "eleme.product.item.listIngredientGroups", params)
}
...
func (item *Item) DeleteIngredientGroup(ingredientGroupId_ int64) (interface{}, error) {
	params := make(map[string]interface{})
	params["ingredientGroupId"] = ingredientGroupId_
	return APIInterface(item.config, "eleme.product.item.deleteIngredientGroup", params)
}
...
func (item *Item) BindIngredientGroups(itemId_ int64, ingredientGroupIds_ interface{}) (interface{}, error) {
	...
	params["itemId"] = itemId_
	params["ingredientGroupIds"] = ingredientGroupIds_
	return APIInterface(item.config, "eleme.product.item.bindIngredientGroups", params)
}
...
func (item *Item) UnbindIngredientGroups(itemId_ int64, ingredientGroupIds_ interface{}) (interface{}, error) {
	...
	params["itemId"] = itemId_
	params["ingredientGroupIds"] = ingredientGroupIds_
	return APIInterface(item.config, "eleme.product.item.unbindIngredientGroups", params)
}
...
func (item *Item) RemoveMainItemIngredientGroups(itemId_ int64) (interface{}, error) {
	params := make(map[string]interface{})
	params["itemId"] = itemId_
	return APIInterface(item.config, "eleme.product.item.removeMainItemIngredientGroups", params)
}
